...
import 'package:contact_gallery/provider/edit_contact_change_notifier.dart';
    ...
    MultiProvider(
      providers: [
        ChangeNotifierProvider(
          create: (context) => AddContactChangeNotifier(),
        ),
        ChangeNotifierProvider(
          create: (context) => EditContactChangeNotifier(),
        )
      ],
      child: const Main(),
    ),
